...
if (ev->type==EV_SW)
{
	switch (ev->code)
	{
		case SW_LID: return("sw:lid"); break;
		case SW_RFKILL_ALL: return("sw:rfkill"); break;
		case SW_DOCK: return("sw:dock"); break;
		case SW_TABLET_MODE: return("sw:tablet"); break;
	}
}
else
{
	switch (ev->code)
	{
		case BTN_A: return("btn:A"); break;
		case BTN_B: return("btn:B"); break;
		case BTN_C: return("btn:C"); break;
		case BTN_X: return("btn:X"); break;
		case BTN_Y: return("btn:Y"); break;
		case BTN_Z: return("btn:Z"); break;
		case BTN_SELECT: return("btn:select"); break;
		case BTN_START: return("btn:start"); break;
		case BTN_MODE: return("btn:mode"); break;
		case BTN_TL: return("btn:ltrig"); break;
		case BTN_TR: return("btn:rtrig"); break;
		case BTN_DPAD_UP: return("btn:up"); break;
		case BTN_DPAD_DOWN: return("btn:down"); break;
		case BTN_DPAD_LEFT: return("btn:left"); break;
		case BTN_DPAD_RIGHT: return("btn:right"); break;
	}
}
...
while (1)
{
	...
	switch (ev.type)
	{
		case EV_ABS: Axis[ev.code]=ev.value; break;
