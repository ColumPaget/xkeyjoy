...
typedef enum {ACT_SENDKEY, ACT_EXEC, ACT_WINCLOSE, ACT_WINKILL, ACT_WINHIDE, ACT_WINSHADE, ACT_WINSTICK, ACT_WINFULLSCR, ACT_WINMAX_X, ACT_WINMAX_Y, ACT_WINRAISED, ACT_WINLOWERED, ACT_SWITCH_DESKTOP, ACT_NEXT_DESKTOP, ACT_PREV_DESKTOP, ACT_ADD_DESKTOP, ACT_DEL_DESKTOP, ACT_UNGRAB_POINTER} EActions;
